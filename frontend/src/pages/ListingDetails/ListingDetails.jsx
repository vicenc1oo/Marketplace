...
export default function ListingDetails() {
  ...
  const onPlaceBid = async (amount) => {
    ...
    try {
      ...
      setListing((prev) => ({ ...prev, currentBid: amount, bidsCount: (prev.bidsCount ?? 0) + 1 }));
  ...
  const sendContact = (e) => {
    ...
    // Backend integration point: create/lookup a conversation, then send.
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button onClick={sendContact} disabled={!message.trim()}>Send message</Button>
          </>
        }
      >
